<script>
	...
	import headerImage from '../../assets/big-brain.png';
</script>

<svelte:head>
	<title>Survey</title>
	<meta name="description" content="Information gather from survey" />
</svelte:head>
<Container>
	<div class="flex flex-col">
		<div class="flex items-center justify-center">
			<img src={headerImage} alt="undraw_svg" width="300" />
			<div>
				<div class="text-sm">LNG320</div>
				<div class="text-4xl">Data From Survey</div>
				<div>These data are mostly from KMUTT students</div>
			</div>
		</div>
		<div class="my-10 flex items-center">
			...
			<div class="flex flex-1 p-3">
				<p class="text-left text-xl">
					From the responses, most of the respondents are KMUTT students that are related with
					programming fields. We ask for their consent in order to use their personal information
					and responses on our website.
				</p>
			</div>
		</div>
		<div class="my-10 flex flex-col text-center">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				programming for 3-5 years and more than 5 years, show the same result at <b>17.2%</b> of
				total respondents. The last group of respondents, which is the people who just started
		...
		<div class="flex flex-col text-center ">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				haven’t known or used AI Tools before. However, we believe that some of them might already know
				about the existence of AI Softwares but they’d rather use their own pure computer skills than
				ask AI for help. Some believe that their skills might be wasteful with AI compared to coding
		...
		<div class="my-20 flex items-center">
			...
			<div class="flex flex-1 p-3">
				<p class="text-left text-xl">
					Our responses showed that <b>93.3%</b> of respondents have been using
					<b><span class="text-violet-600"> Github Copilot.</span></b> We find it makes sense that most
					people are using Github Copilot because it is the most popular AI Software in comparison to
					others.
				</p>
			</div>
		</div>
		<div class="my-10 flex flex-col text-center">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				responses,
				<b>13.3%</b> of respondents are using AI in coding for 6 - 12 months and <b>6.7%</b> of respondents
				use them more than a year. We can conclude that some respondents used AI for coding for a long
		...
		<div class="my-10 flex flex-col text-center">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				So, we can say that AI can enhance our work and help them in programming work, and
		...
		<div class="my-10 flex flex-col text-center">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				hypothesis is that the backend field is less popular than the frontend field, making AI
				suggest at the frontend is better than the backend work. But as the percentage of positive
				answers is much higher than negative answers, we cannot disagree that it helps people to do
				their work, as some work requires a lot of boilerplate code which is not effective to write
		...
		<div class="my-10 flex flex-col text-center">
			...
			<p class="my-5 text-justify indent-10 text-xl">
				...
				are people who said no. According to the data, we can assume that using AI in coding helps most
				people to do their work, but in some fields of work it is not necessary to use it due to fewer
				data used for training AI making its accuracy lower.
			</p>
		</div>
	</div>
</Container>
